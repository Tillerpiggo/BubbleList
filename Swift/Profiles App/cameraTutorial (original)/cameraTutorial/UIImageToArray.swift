//
//  UIImageToArray.swift
//  cameraTutorial
//
//  Created by Tyler Gee on 6/7/18.
...
struct ImageToArray {
    private func rgbaToArray(_ rgba: RGBA) -> [[UInt8]] {
    ...
    private func emptyArrayOfSize(_ width: Int, _ height: Int) -> [[UInt8]] {
    ...
    private func resizeArray(_ array: [[UInt8]], width: Int, height: Int) -> [[UInt8]] {
    ...
    private func averageBrightness(for array: [[UInt8]], startX: Int, endX: Int, startY: Int, endY: Int) -> UInt8 {
        var brightness = 0
    ...
    private func pixelAt(_ x: Int, _ y: Int, rgba: RGBA) -> Pixel {
        let index = y * rgba.width + x
        let pixel = rgba.pixels[index]
    ...
    // most important functions: Turns a UIImage into an array
    func imageToArray(_ image: UIImage, width: Int, height: Int) -> [[UInt8]] {
        let rgba = RGBA(image: image)
        let array = rgbaToArrayOfSize(rgba!, width: width, height: height)
        
        return array
    }
    
    private func rgbaToArrayOfSize(_ rgba: RGBA, width: Int, height: Int) -> [[UInt8]] {

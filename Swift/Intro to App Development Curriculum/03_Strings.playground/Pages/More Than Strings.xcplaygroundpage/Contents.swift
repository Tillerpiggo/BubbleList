...
let name = "Algee and Co"
let numberOfDollars = "50 billion"
let adjectiveOfThingToBuy = "moist"
let thingToBuy = "better mic"
let placeObject = "Dank Rock"
let place = "Basement"
let positiveEmotion = "depressed"
let negativeEmotion = "the will to live"
let noun = "SR"

let story = "Today was a big day for \(name). They had finally saved up \(numberOfDollars) dollars and were going to buy a \(adjectiveOfThingToBuy) \(thingToBuy). They went to the \(placeObject) \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They were all out of \(noun)!"
//:
//:

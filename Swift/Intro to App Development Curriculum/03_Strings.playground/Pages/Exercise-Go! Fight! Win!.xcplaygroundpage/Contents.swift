...
let refrain = "yeet the meet, kill the fleet, \(schoolName), beet the heet, \(schoolName), yeet the meet"
let ending = "\(schoolName), yeet, \(schoolName), meet, \(schoolName), beet, \(schoolName), fleet!"
let song = "\(refrain)\n\(refrain)\nYes, \(refrain)\n\(ending)"

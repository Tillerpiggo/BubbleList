...
let numberOfImpossibleBeliefs = impossibleBeliefsCount(pigsFlying: 10, frogsBecomingPrinces: 2, multipleLightningStrikes: 5)

impossibleThingsPhrase(numberOfImpossibleThings: numberOfImpossibleBeliefs, meal: "teatime")

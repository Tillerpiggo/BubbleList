...
// returns the number of dabs you've participated in today, takes time in military time (hours)
func currentDailyDabs(currentTime: Int, wakeUpTime: Int) -> String {
    let dabsPerHour = 60
    let dailyDabs = (currentTime - wakeUpTime) * dabsPerHour
    
    return "You've dabbed \(dailyDabs) times today! Get to 10,000 to beat your record!"
}

currentDailyDabs(currentTime: 12, wakeUpTime: 6)

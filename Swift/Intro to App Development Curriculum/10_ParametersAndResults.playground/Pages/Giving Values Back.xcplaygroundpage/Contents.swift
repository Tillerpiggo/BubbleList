...
let favoriteDab = makeFavorite(categoryOfThing: "dab", favorite: "kashi")
let favoriteAquaponics = makeFavorite(categoryOfThing: "aquaponics system", favorite: "crappy farming")
...
"Hello, my name is Algee. \(favoriteDab) \(favoriteAquaponics)"

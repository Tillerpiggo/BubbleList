...
// total time it takes to complete my morning routine
let morningRoutine = getUp + eatBreakfast + getDressed + brushTeeth + packBag
...
let haveToDo = getUp + getDressed + packBag
let likeToDo = eatBreakfast + brushTeeth
haveToDo + likeToDo

 ...
 */
// voting option counters
var beachVotes = 0
var chocolateFactoryVotes = 0

// count votes
for tripDestination in tripDestinationVotes {
...
//print results
print("Where should we go on a field trip? \(beachVotes) say to the beach, \(chocolateFactoryVotes) say to the chocolate factory")
...
// print results
print("What should our school mascot be? \(marmotVotes) say a marmot, \(salamanderVotes) say a salamander, and \(neitherVotes) say neither")

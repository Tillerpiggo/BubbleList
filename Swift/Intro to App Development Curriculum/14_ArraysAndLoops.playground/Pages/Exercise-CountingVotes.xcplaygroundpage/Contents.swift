...
// determines the results of a poll, prints the results
func countVotes(of array:[Bool], withIssue issue:String) {
    var yesVotes = 0
    var noVotes = 0
...
// store the answer in constants
countVotes(of: shouldMascotChangeVotes, withIssue: "Should we change the mascot?")
countVotes(of: shouldInstallCoffeeVendingMachineVotes, withIssue: "Should we install a coffee vending machine?")
countVotes(of: shouldHaveMorePollOptionsVotes, withIssue: "Should we have more poll options?")

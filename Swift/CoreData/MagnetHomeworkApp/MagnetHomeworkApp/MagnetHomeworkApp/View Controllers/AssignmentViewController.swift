...
class AssignmentViewController: ToDoTableViewController {
    ...
    override var sectionNameKeyPath: String { return #keyPath(Assignment.dueDate.dueDateType.string) }
    
    override var sortDescriptors: [NSSortDescriptor] {
        let sortBySectionNumber = NSSortDescriptor(key: #keyPath(Assignment.dueDate.dueDateType.section), ascending: true)

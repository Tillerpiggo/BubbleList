...
let myRunningWorkout = RunningWorkout(distance: 50, time: 10)
let mySwimmingWorkout = SwimmingWorkout(distance: 100, time: 50)

simpleWorkoutDescription(workout: myRunningWorkout)
simpleWorkoutDescription(workout: mySwimmingWorkout)

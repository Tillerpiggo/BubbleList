...
struct RunningWorkout {
    ...
    var averageMileTime: Double {
        let mileDistance: Double = 1600
        let averageMileTime: Double = (mileDistance*time) / distance
        
        return averageMileTime
    }
}

var myWorkout = RunningWorkout(distance: 400, time: 1.5, elevation: 0)
...
var almostThere = Steps(steps: 9_999, goal: 10_000)

almostThere.takeStep()

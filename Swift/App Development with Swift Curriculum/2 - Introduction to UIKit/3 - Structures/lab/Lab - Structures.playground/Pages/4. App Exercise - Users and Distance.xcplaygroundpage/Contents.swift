 ...
 */
let tyler = User(name: "Tyler", age: 14, height: 55.3, activityLevel: 3)

print("\(tyler.name) is \(tyler.age). He is \(tyler.height) inches tall, and has an activity level of \(tyler.activityLevel).")
...
let exampleDistance = Distance(meters: 1600)
print(exampleDistance.feet)

/*:
 Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
 */
let mile = Distance(feet: 5249.344)
print(mile.meters)

/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
let unitDistance = Distance(meters: 1)
print(unitDistance.feet)

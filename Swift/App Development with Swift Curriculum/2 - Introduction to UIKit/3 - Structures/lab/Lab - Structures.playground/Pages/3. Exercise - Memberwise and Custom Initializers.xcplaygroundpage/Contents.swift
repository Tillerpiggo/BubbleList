...
let favoriteBook = Book(title: "App Development with Swift", author: "Apple", pages: 993, price: 0.0)

print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author). It has \(favoriteBook.pages) pages, and costs $\(favoriteBook.price)0.")

...
struct User {
    ...
    static var currentUser: User = User(userName: "Tyler", email: "rolliepig@iCloud.com", age: 14)
...
var userWhoIsMe = User.currentUser
userWhoIsMe.logIn(user: User(userName: "Doge", email: "", age: 11234))
/*:

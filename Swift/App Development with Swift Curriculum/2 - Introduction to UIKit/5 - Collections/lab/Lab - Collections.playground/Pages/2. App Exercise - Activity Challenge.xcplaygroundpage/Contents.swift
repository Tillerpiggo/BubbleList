 ...
 */
var walkingChallenges = ["Walk 3 miles a day", "Walk for 2 weeks in a row"]
var runningChallenges = ["Run 5 times a week", "Run a mile in under 7 minutes"]
...
print("The first running challenge: \(challenges[1][0]).")
 ...
 */
var committedChallenges = ["Don't be a couch potato.", "Dab 50 times in one day"]

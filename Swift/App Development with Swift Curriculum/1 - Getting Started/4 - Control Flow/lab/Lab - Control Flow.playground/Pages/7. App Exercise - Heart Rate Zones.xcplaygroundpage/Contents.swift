...
default:
    print("You are in the ??? zone. Activity in this zone is unaccounted for. Legally we have to warn you that there is a possibility of death.")
}

if currentHR > 200 {
    print("You are in the kys zone. Activity in this zone will give you a freaking heart attack.")
}

...
func foodForMeal(_ meal: String) -> Meal? {
    if let mealObject = meals[meal] {
        return mealObject
    } else {
        return nil
    }
...
print(foodForMeal("Breakfast"))
print(foodForMeal("Lunch"))
print(foodForMeal("Dinner"))

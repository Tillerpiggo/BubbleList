...
calculateArea(x: -1, y: 10)
calculateArea(x: 5, y: 4)
calculateArea(x: 2, y: -1)
 ...
 */
func add(_ int1: Int?, and int2: Int?) -> Int? {
    guard let firstInt = int1, let secondInt = int2 else { return nil }
...
let firstNameTextField: UITextField? = nil
...
if let firstName = newUser?.firstName {
